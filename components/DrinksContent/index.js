...
function DrinksContent() {
  return (
    <ScrollView>
      <View>
        <Text>Bebidas</Text>
        <Image
          source={{ uri: 'https://www.amexessentials.com/wp-content/uploads/2018/10/opener-whisky-101.jpg' }}
          style={{
            width: 300,
            height: 300,
          }}
        ...
        <Text>
        Historia del whisky
  Es posible que la destillation fuera practicada por los babilonios en Mesopotamia en el 2º milenio AC, para producir perfumes.6​

  Hay certeza que la destilación era conocida por los griegos de Alejandría en el Siglo IDC,7​ pero no era usada para producir alcohol. Esta tecnología fue traspasada por los árabes a los latinos durante la Edad Media, y los primeros registros en latín son de comienzos del siglo XII.7​8​
  ...
  A mediados del siglo XIX los escoceses comenzaron a mezclar su whisky de malta con whisky de grano más liviano y barato. Fue Andrew Usher (enlace roto disponible en Internet Archive; véase el historial, la primera versión y la última). y Cía. quien en 1850 produjo el primer whisky de mezcla; mientras que el whisky americano fue fundado con la tecnología y el saber de los primeros colonos escoceses y hoy en día hay destilerías alrededor del planeta.
